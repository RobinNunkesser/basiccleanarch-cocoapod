...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BasicCleanArch.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Robin Nunkesser/BasicCleanArch'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Robin Nunkesser' => 'robin.nunkesser@hshl.de' }
  s.source           = { :git => 'https://github.com/Robin Nunkesser/BasicCleanArch.git', :tag => s.version.to_s }
